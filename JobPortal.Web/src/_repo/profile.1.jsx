...
class Profile extends Component {
	...
	onHandleClick = (e, resumeFile, coverFile) => {
		...
		if (resumeFile) {
			...
			const resumeConfig = {
				...
				//<-- jpeg = jpeg/jpg
				//'image/jpeg', 'image/png','image/jpg','application/vnd.ms-excel','application/vnd.openxmlformats-officedocument.wordprocessingml.document','application/docx','application/pdf','text/plain','application/msword','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'
	...
	render() {
		...
		const { profileInfo, userDocument, profileBiodata, biodata, phoneNumber, genderId, countryId, stateId, cityId, addressLine1, firstName, lastName, middleName, state, city, profile, countries, states, cities, genders } = this.state;
